$(document).ready(function () {
    ...
    $(document).on('click', '.call_team', function (e) {
        let width = $(window).width();
        $(".content-site").addClass("d-none");
        $(".index_team").removeClass("d-none");
        return false;
    });
    $(document).on('click', '.xsvg', function (e) {
        $(".content-site").removeClass("d-none");
        $(".index_team").addClass("d-none");
